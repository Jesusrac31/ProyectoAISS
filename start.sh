...
java -Xmx120m -jar /app/dailymotion.jar --server.port=8081 &

echo "Starting PeerTube Miner in port 8082..."
java -Xmx120m -jar /app/peertube.jar --server.port=8082 &

echo "Starting VideoMiner in port 8083..."
java -Xmx120m -jar /app/videominer.jar --server.port=8083 &
